...
![1574607430115](Elasticsearch 安装.assets/1574607430115.png)
...
![1574607864042](Elasticsearch 安装.assets/1574607864042.png)
...
![1574609255103](Elasticsearch 安装.assets/1574609255103.png)
...
![1574609539550](Elasticsearch 安装.assets/1574609539550.png)

此时elasticsearch已成功启动：

```
重点几个关注下即可:number" : "7.4.0"   表示elasticsearch版本lucene_version" : "8.2.0"  表示lucene版本name ： 默认启动的时候指定了 ES 实例名称cluster_name ： 默认名为 elasticsearch
```
...
```shell
server.port: 5601server.host: "0.0.0.0"server.name: "kibana-itcast"elasticsearch.hosts: ["http://127.0.0.1:9200"]elasticsearch.requestTimeout: 99999
```
...
```shell
# 切换到kibana的bin目录cd /opt/kibana-7.4.0-linux-x86_64/bin# 启动./kibana --allow-root
```

![1574610511959](Elasticsearch 安装.assets/1574610511959.png)
...
![1574610669598](Elasticsearch 安装.assets/1574610669598.png)
...
![1571160484991](Elasticsearch 安装.assets/1571160484991.png)
...
![1571160606899](Elasticsearch 安装.assets/1571160606899.png)
...
![1571160954958](Elasticsearch 安装.assets/1571160954958.png)
...
![1571161497433](Elasticsearch 安装.assets/1571161497433.png)

查看grunt版本

![1571161600969](Elasticsearch 安装.assets/1571161600969.png)
...
![1571161083235](Elasticsearch 安装.assets/1571161083235.png)
...
![1571193736229](Elasticsearch 安装.assets/1571193736229.png)
...
```shell
#开启cors跨域访问支持，默认为false http.cors.enabled: true#跨域访问允许的域名地址，(允许所有域名)以上使用正则http.cors.allow-origin: "*"
```
...
![1571163304853](Elasticsearch 安装.assets/1571163304853.png)

5) 访问head

浏览器输入ip:port:9100，如下图

![1571163462191](Elasticsearch 安装.assets/1571163462191.png)
