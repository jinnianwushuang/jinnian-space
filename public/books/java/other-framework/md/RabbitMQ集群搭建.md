...
![1565245219265](RabbitMQ集群搭建.assets/1566073768274.png)
...
![1566065096459](RabbitMQ集群搭建.assets/1566065096459.png)
...
![1566072300852](RabbitMQ集群搭建.assets/1566072300852.png)
...
```shell
/usr/local/haproxy/sbin/haproxy -f /etc/haproxy/haproxy.cfg//查看haproxy进程状态ps -ef | grep haproxy访问如下地址对mq节点进行监控http://172.16.98.133:8100/rabbitmq-stats
```
