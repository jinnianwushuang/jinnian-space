...
![2](传智健康项目讲义-day2.assets/2.png)

 

![3](传智健康项目讲义-day2.assets/3.png)

（2）创建本项目使用的数据库itcast_health

![4](传智健康项目讲义-day2.assets/4.png)

（3）将PowerDesigner导出的SQL脚本导入itcast_health数据库进行建表

![5](传智健康项目讲义-day2.assets/5.png)
