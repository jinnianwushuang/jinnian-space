 ...
 * @FilePath       : /jinnian-space/src/pages/essay/index.vue
 * @Description    :
-->
<template>
  <div>
...
<script>
let  relative_path='/books/essay/'
 import {compute_config_base_on_require_context} from "src/boot/require-utils.js"
let { all_components, all_modules } =compute_config_base_on_require_context(require.context('public/books/essay/', false, /\.md$/),'md',false)
