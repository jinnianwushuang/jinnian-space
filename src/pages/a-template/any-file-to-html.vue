...
<script>
/** 
 * 特点是 东西全部打进来 了 针对 配置文件之类的 conf  . type 等 任何文件   , 同步
*/
let  relative_path='/books/java/maven/'
 import {compute_config_base_on_require_context} from "src/boot/require-utils.js"
let { all_components, all_modules } =compute_config_base_on_require_context(require.context('public/books/java/maven/', false, /\.conf$/),'conf',true,true,true)
